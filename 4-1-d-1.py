...
line2 = "2018 Test log line 192.168.1.1 pinged your hostname test.com"
...
# Find MAC
match = re.search("[0-9a-f]{2}:[0-9a-f]{2}:[0-9a-f]{2}:[0-9a-f]{2}:[0-9a-f]{2}:[0-9a-f]{2}", line2, re.IGNORECASE)
